...
test("matches the 109 released sprites in the Fortnite.GG catalog", () => {
  const app = createApp();
  ...
  assert.deepEqual(
    Array.from(catalog).filter(sprite => [
      ...
      "john-wick-sprite", "quack-water-sprite", "quack-earth-sprite", "quack-fire-sprite",
    ...
    [
      "John Wick Sprite", "Batman Sprite", "Holofoil Batman Sprite", "Cube Batman Sprite",
